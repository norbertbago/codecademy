...
# Create a function named large_power() that takes two parameters named base
# and exponent. If base raised to the exponent is greater than 5000,
...
# Create a function named twice_as_large() that has two parameters named
# num1 and num2. Return True if num1 is more than double num2.
...
# num1 and num2. Return True if num1 and num2 do not sum to 10. Return
# False otherwise.
